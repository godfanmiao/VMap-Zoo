...
model = dict(
    ...
    pretrained = '/home/xiaoxu/work/yaoyi/HDMap/V_VMap_Test/pretrained/checkpoint-799.pth',
    backbone_cfg=dict(
        type='ConvNeXtV2',
        depths=[2, 2, 6, 2],
        dims=[40, 80, 160, 320],
...
eval_config = dict(
    type='NuscDataset',
    data_root='/home/xiaoxu/work/yaoyi/HDMap/V_VMap_Test/datasets/nuscenes',
    ann_file='/home/xiaoxu/work/yaoyi/HDMap/V_VMap_Test/datasets/nuscenes/nuscenes_map_infos_val.pkl',
    meta=meta,
    roi_size=roi_size,
    cat2id=cat2id,
    pipeline=[
...
data = dict(
    ...
    train=dict(
        type='NuscDataset',
        data_root='/home/xiaoxu/work/yaoyi/HDMap/V_VMap_Test/datasets/nuscenes',
        ann_file='/home/xiaoxu/work/yaoyi/HDMap/V_VMap_Test/datasets/nuscenes/nuscenes_map_infos_train.pkl',
        meta=meta,
        roi_size=roi_size,
        cat2id=cat2id,
